...
# Route multipart spool/temp files to the configured upload temp dir (off the
# small root disk) and keep the in-RAM spool threshold low so large uploads
# spill to disk instead of being buffered in memory. The directory itself is
